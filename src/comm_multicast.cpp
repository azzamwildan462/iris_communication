...
// #define COMM_DEBUG // Debug lebih dalam
// #define COMM_DEBUG_MINOR // Debug sedikit
...
void putDBData()
{
    ...
    {
        memcpy(put_keys[i] + put_keys_size[i] - 1, recv_data + 3, 1);
        // Final safety
...
void saveData()
{
    ...
    // printf("[recv] odom_%d: %d %d %d\n",msg_multicast_rx.identifier, msg_multicast_rx.pos_x_robot, msg_multicast_rx.pos_y_robot, msg_multicast_rx.theta_robot);
